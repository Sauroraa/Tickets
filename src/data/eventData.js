...
export const lineup = {
  ...
  artists: [
    ...
    { time: '23h00 - 23h45', name: 'The Prototypes', tag: 'IN CONFIRMATION', blur: true },
    { time: '23h45 - 00h45', name: 'NXW & Juliux & Jack-E', tag: 'BDAY SET \u2022 1H', blur: true },
    { time: '00h45 - 01h30', name: 'Tsuki / BadHabitz', tag: 'SHOWCASE', blur: true },
    { time: '01h30 - 02h15', name: 'Jump UP Cave', tag: 'IN CONFIRMATION', blur: true },
    { time: '02h15 - 03h00', name: 'Fanatics B2B Latte', tag: 'IN CONFIRMATION', blur: true },
    { time: '03h00 - 03h45', name: 'Sero B2B Sedativ B2B MATOX B2B Zequals', tag: null, blur: true },
    { time: '03h45 - 04h30', name: 'Chamber B2B Big Jay', tag: null },
    { time: '04h30 - 05h15', name: 'Skamm B2B Lixed', tag: null, blur: true },
